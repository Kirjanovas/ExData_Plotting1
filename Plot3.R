...
legend("topright", pch = "", lwd=1,col = c("black","red", "blue"),text.width = 60000 ,legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
dev.copy(png, file = "Plot3.png",width = 480, height = 480,pointsize = 12) ## Copy Plot3 to a PNG file
dev.off()